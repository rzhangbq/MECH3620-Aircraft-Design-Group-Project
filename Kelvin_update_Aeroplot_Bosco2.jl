...
begin
	# AIRFOIL PROFILES
	foil_w_r = read_foil("C:\\Users\\edeli\\Downloads\\MECH3620_opt_main_wing_0.dat") # Root
	foil_w_m = read_foil("C:\\Users\\edeli\\Downloads\\MECH3620_opt_main_wing_2.dat") # Midspan
	foil_w_t = read_foil("C:\\Users\\edeli\\Downloads\\MECH3620_opt_main_wing_4.dat") # Tip
end
...
# ╔═╡ 3162097c-7643-4e16-9b37-b19bfb361d2b
begin
	
	T_e = 16010 #N takeoff thrust of one engine
	y_t = 2 #m distance from engine to cg
	V_stall = 56.54 #m/s 110 knots
	angle = 25 #degree rudder deflection
	rho = 0.5 #kg/m^3 at 8500 ft
	C_Lav = 0.1 #vertical tail SC(2)-0010 lift curve slope
	eta = 1 #(q_v/q_in) vt dynamic pressure ratio
	#rudder-chord-to-vertical-tail-chord ratio

end

# ╔═╡ 878b624c-26bd-4970-a97f-4f7f2f427d69
# Critical engine-out yawing moment
N_tcrit = T_e * y_t

# ╔═╡ ffc1470e-7844-4573-b930-22b761b5426d
#Drag-induced yawing moment
N_D = 0.15 * N_tcrit #low-BPR jet

# ╔═╡ caab4261-e973-4af9-998f-89036303cab0
Totel_N = N_tcrit + N_D

# ╔═╡ 30759f17-6d5d-4c3f-939b-cab0fc5db0fd
V_mc = 1.2 * V_stall #minimum control speed

# ╔═╡ c54b23bf-6e7c-4c74-8202-358e755fdcb9
q = 1/2 * rho * (V_mc)^2

# ╔═╡ 91a996ec-ead6-43ae-af74-3ce76d85e4e9
C_n = - C_Lav * V_v * eta * 0.32 * 0.8977
# C_n = eta * C_Lvt * (S_v/S_w) * (l_vtcg/b_w) * spanfactor * 0.32

# ╔═╡ 0d7c49a3-eb5f-4106-9712-f9d0943f3636
M_v = q * S_v * b_v * C_n * angle
...
# ╔═╡ 95b0ecbd-8e25-4e20-8536-1a01d99c5d66
begin #estimated parameters
	l_vtcg = 11.273 - x_cg
	C_Lvt = 1 #rolling moment dihedral effect by vt
	spanfactor = 1
end
