...
# ╔═╡ e40aed6d-767c-4d0c-b577-0cea8b37dfba
begin
	FFs = [takeoffFF, climbFF, cruise1FF, loiterFF, landingFF]
...
# ╔═╡ 69fff4fb-306c-4d5c-aadd-5ab8fa4f5cbd
begin
	WTO_range = 1000:500:10000 # kg
	WeWTO_range = empty_weight_raymer.(WTO_range .* g, A, C) # Broadcasting over range
...
WTOs, errors = compute_maximum_takeoff_weight(7500g, Wpayload, Wcrew, Wf_man, A, C)

# ╔═╡ e35003bc-51e9-4d83-b160-4c8dc3974ec8
begin
	plot1 = plot(WTOs, 
		label = "", 
		ylabel = "MTOW (N)", 
